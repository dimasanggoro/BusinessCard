...
Column(
   ...
   val image = painterResource(id = R.drawable.android_logo)
    Image(painter = image, contentDescription = null, modifier = Modifier
        .height(120.dp)
        .width(150.dp))
    Text(text = stringResource(R.string.mynama),color = Color.White)
  ...
  Column(
      ...
      Row(
          ...
          Text(text = stringResource(R.string.nim), modifier = Modifier.padding(start = 110.dp),color = Color.White)
